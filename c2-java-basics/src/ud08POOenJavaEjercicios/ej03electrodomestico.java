...
public class ej03electrodomestico {
	...
	public ej03electrodomestico(double precioBase, double peso) {
	...
	public ej03electrodomestico(double precioBase, String color, char consumoEnergetico, double peso) {
		this.precioBase = precioBase;
		this.color = color;
